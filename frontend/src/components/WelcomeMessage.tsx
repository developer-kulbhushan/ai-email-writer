...
export const WelcomeMessage: React.FC<WelcomeMessageProps> = ({ onQuickStart, isDarkMode }) => {
  ...
  return (
    <div className="text-center py-12">
      ...
      <p className={`mb-8 max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
        {quickStartExamples.map((example, index) => (
          <button
            ...
            className={`p-4 text-left border rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 ${
              isDarkMode 
